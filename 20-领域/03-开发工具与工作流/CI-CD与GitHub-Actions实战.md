...
> 关联阅读:[测试夹具是什么](<../10-名词解释/测试夹具是什么.md>)(流水线里跑的"验收清单")、[Node.js,npm,pnpm的作用与关系](<../10-名词解释/Node.js,npm,pnpm的作用与关系.md>)(`npm ci` / lockfile)、[CLI,TUI,GUI三种界面的区别](<../10-名词解释/CLI,TUI,GUI三种界面的区别.md>)。
