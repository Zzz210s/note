...
MOC_DIRS: dict[str, tuple[str, ...]] = {
    ...
    "编程语言.md": ("20-领域/02-编程语言", "20-领域/03-开发工具与工作流", "20-领域/10-名词解释",
                "50-资源/工具"),
    "系统.md": ("20-领域/04-操作系统与嵌入式", "20-领域/05-网络与服务器", "20-领域/06-部署与运维",
                "20-领域/07-数据库", "10-项目/!问题追踪", "50-资源/记录", "50-资源/Zephyr"),
    "外语.md": ("20-领域/08-外语", "10-项目/2026-掌握西班牙语B2", "10-项目/!六级英语每日一练"),
